...
*¿De aquí a los próximos años, en qué parte de Colombia conviene tener cultivos de café exactamente, cuál es su probabilidad de que el negocio prospere y en qué porcentaje prosperaría?*

Este documento detalla la anatomía de los datos que alimentan al modelo de Inteligencia Artificial (Agro-Rank) para resolver esta pregunta de negocio, y presenta el diagrama de arquitectura del proceso de principio a fin.
